1. console.log(word+' '+second+' '+third+' '+fourth+' '+fifth+' '+sixth+' '+seventh)

2.  var word = 'wow JavaScript is so cool';
...
3.  var word3 = 'wow JavaScript is so cool';
...
4.  var word4 = 'wow JavaScript is so cool';
